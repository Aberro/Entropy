...
public enum ImGuiMultiSelectFlags
{
	...
	/// <summary>
	/// Shift+Selection uses 2d geometry instead of linear sequence, so possible to use Shift+up/down to select vertically in grid. Analogous to what BoxSelect does.
	/// </summary>
	[Obsolete]
	RangeSelect2d = 1 << 15,
	/// <summary>
