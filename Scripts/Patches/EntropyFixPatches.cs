...
namespace Entropy.Scripts.Patches
{
    ...
    public class AtmosphereCalculateThingEntropyPatch
    {
        ...
        public static bool Prefix(Thing thing, Atmosphere worldAtmosphere, Atmosphere internalAtmosphere, float scale, ref float __result)
        {
            ...
            Atmosphere globalAtmosphere = AtmosphericsController.ReadonlyGlobalAtmosphere(thing.GridPosition);
            ...
            var thingTemperature = globalAtmosphere.Temperature < TemperatureKelvin.One ? new TemperatureKelvin(50f) : globalAtmosphere.Temperature;
