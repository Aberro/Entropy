...
{ 
	...
	/// </summary>
	[Obsolete("[BETA] On child window: allow gamepad/keyboard navigation to cross over parent border to this child or between sibling child windows.")]
	NavFlattened = 1 << 23,
	/// <summary>
	/// Don't use! For internal use by BeginChild()
	/// </summary>
	[Obsolete("Don't use! For internal use by BeginChild()")]
	ChildWindow = 1 << 24,
	/// <summary>
	/// Don't use! For internal use by BeginTooltip()
	/// </summary>
	[Obsolete("Don't use! For internal use by BeginTooltip()")]
	Tooltip = 1 << 25,
	/// <summary>
	/// Don't use! For internal use by BeginPopup()
	/// </summary>
	[Obsolete("Don't use! For internal use by BeginPopup()")]
	Popup = 1 << 26,
	/// <summary>
	/// Don't use! For internal use by BeginPopupModal()
	/// </summary>
	[Obsolete("Don't use! For internal use by BeginPopupModal()")]
	Modal = 1 << 27,
	/// <summary>
	/// Don't use! For internal use by BeginMenu()
	/// </summary>
	[Obsolete("Don't use! For internal use by BeginMenu()")]
	ChildMenu = 1 << 28,
	/// <summary>
