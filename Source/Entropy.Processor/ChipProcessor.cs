...
public partial class ChipProcessor
{
	...
	public static IDictionary<string, string> GetEnumerationValues() => ProcessorProvider.ListOfIdentifiers();
	...
	public static ChipProcessor Translate(ProgrammableChip chip)
	{
		...
		{
			ProcessorMod.Instance.Logger.LogWarning("Error while compiling the script: \n" + e);
	...
	private static void GenerateLineCode(LineOfCode line, CodeGeneratorData data, int lineNumber)
	{
		...
		var isCorrectNumberOfArguments = arguments.Length switch
		{
		...
		var isValid = arguments.Length switch
		{
